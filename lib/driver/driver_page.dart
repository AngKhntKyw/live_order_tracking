                ...
                body: Stack(
                  children: [
                    GoogleMap(
                      ...
                      polylines: driverController.polylineCoordinates.isEmpty
                          ? {}
                          : {
                              Polyline(
                                polylineId: const PolylineId('driver'),
                                color: Colors.purple,
                                points: driverController.polylineCoordinates,
                                width: 5,
                              ),
                            },
                    ),
                    DraggableScrollableSheet(
                      ...
                      builder: (context, scrollController) {
                        return driverController.state == 'goingToPickUp'
                            ? Container(
                                ...
                                child: const Center(
                                  child: Text("Going to pick up location"),
                                ),
                              )
                            : Container(
                                decoration: const BoxDecoration(
